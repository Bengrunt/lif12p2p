...
/**
* \brief structure stockant les informations nécéssaires pour satisfaire la requete d'un client.
...
/**
* \brief file d'attente des clients (FIFO).
...
/**
* \brief structure pour donner toutes les données nécessaire à la création d'un message
...
/**
* \brief structure stockant les informations nécéssaires pour le téléchargement d'un bloc.
* \param
* \param
*/
...
/**
* \brief file d'attente des téléchargements (FIFO).
...
/**
* \brief structure stockant les informations sur les fichiers en cours de traitement.
...
/**
* \brief liste des fichiers en cours de téléchargement.
...
/**
* \brief Application coté serveur gérant le téléchargement des fichiers.
*/
